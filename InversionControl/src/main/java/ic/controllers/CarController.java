...
public class CarController implements IcarController {
	...
	@Override
	public ResponseEntity<Page<Car>> readAllCars(
	...
	public ResponseEntity<Car> updateCar(@RequestBody CarDTO carDTO) {
		...
		return ResponseEntity.status(HttpStatusCode.valueOf(200)).body(this.icarService.updateCar(this.convertDTO(carDTO)));
